...
const STATUS_VALUES = [...STATUS_PIPELINE, "cancelled"] as const;
...
/**
 * Expanded recipe block for the admin order detail page.
 * Shows recipe name (linked), pet, stats chips, and ingredient tags.
 *
